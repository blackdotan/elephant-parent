 ...
 */
public class QConditionPlugin extends PluginAdapter {

    public static final String METHOD_NAME = "qcondition";
    ...
    public boolean clientSelectByPrimaryKeyMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        iMethod.addParameter(new Parameter(new FullyQualifiedJavaType(String.class.getName()), "condition", "@Param(\"condition\")"));
        iMethod.addAnnotation("/**");
        iMethod.addAnnotation(" * 记录匹配 + 条件，获取数据");
        iMethod.addAnnotation(" **/");
