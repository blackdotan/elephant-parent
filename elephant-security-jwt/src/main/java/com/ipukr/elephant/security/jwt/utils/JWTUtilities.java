...
//	public static Algorithm algorithm = Algorithm.HMAC256("---");
	 ...
	 * @return
	 */
	public static String sign(JWTAuthentication authentication, Algorithm algorithm) {
		String text = JWT.create()
				.withJWTId(authentication.getId().toString())
	 ...
	 * @throws IOException
	 */
	public static JWTAuthentication convert(DecodedJWT jwt) throws IOException {
		...
		JWTAuthentication authen = new JWTAuthentication();
		authen.setId(Integer.valueOf(jwt.getId()));
