 ...
 *
 */
public class Word2ImageUtilities {
     ...
     * @throws IOException
     */
    public static BufferedImage generateWord2Img(String name)
            throws IOException {
        int width = 100;
        int height = 100;
...
//        File file = new File(filename);
        //Font font = new Font(FONT_FAMILY, Font.PLAIN, 30);
        ...
        if (nameWritten.length() >= 2) {
            font = new Font(FONT_FAMILY, Font.PLAIN, 30);
            g2.setFont(font);
        ...
        if (nameWritten.length() == 1) {
            ...
            if (isChinese(nameWritten)) {
                font = new Font(FONT_FAMILY, Font.PLAIN, 50);
                g2.setFont(font);
                g2.drawString(nameWritten, 25, 70);
            }
            //英文
            else {
                font = new Font(FONT_FAMILY, Font.PLAIN, 55);
                g2.setFont(font);
