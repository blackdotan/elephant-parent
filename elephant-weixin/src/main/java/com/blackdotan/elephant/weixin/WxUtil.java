...
public class WxUtil {
     ...
     * @return
     */
    public static WxPhoneInfo getPhoneNumber(String encryptedData, String sessionkey, String iv) throws Exception {
        // 被加密的数据
        byte[] dataByte = Base64.decode(encryptedData);
        // 加密秘钥
        byte[] keyByte = Base64.decode(sessionkey);
        ...
        if (null != resultByte && resultByte.length > 0) {
            ...
            return JsonUtils.parserString2Obj(result, WxPhoneInfo.class);
        }
        return null;
    }
